...
function addCards(data) {
  data.results.forEach((element) => {
    ...
    card.innerHTML = ` <img src="${element.image}" alt="Food Recipe Image">
    <div class="card-body">
...
async function searchRecipeFunction() {
  ...
  if (localStorage.getItem("search") === null) {
    const searchRecipe = `https://api.spoonacular.com/recipes/complexSearch?number=15&diet=${search}&apiKey=${apiKey}`;
